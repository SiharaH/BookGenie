  ...
  return <div id='features' className='relative py-24 lg:py-32 bg-white overflow-hidden'>
    <div className='max-w-7xl mx-auto px-6 lg:px-8 relative'>
        <div className='text-center mb-20 space-y-4'> 
            ...
            <h2 className='text-4xl sm:text-5xl lg:text-5xl font-bold text-gray-900 tracking-tight'>Everything You Need to 
                <span className='block mt-2 bg-gradient-to-r from-violet-600 to-purple-600 bg-clip-text'>Create Your Ebook</span>
            </h2>
            <p className='text-base text-gray-600 max-w-2xl mx-auto'>Our platform provides everything you need to create professional-looking ebooks with ease.</p>
        </div>
                ...
                return (
                    <div key={index} className='group relative bg-white rounded-2xl p-8 border border-gray-100 hover:border-violet-200 transition-all duration-300 hover:shadow-xl hover:shadow-violet-500/10 hover:-translate-y-1'>
                        ...
                        <div className='relative space-y-4'>
                            <div className={`w-14 h-14 bg-gradient-to-br ${feature.gradient} rounded-xl flex items-center justify-center shadow-lg shadow-${feature.gradient}/20 group-hover:scale-110 transition-transform duration-300`}>
        ...
        <div className='text-center mt-16'>
            ...
            <a href="/signup" className='inline-flex items-center space-x-2 bg-gradient-to-r from-violet-600 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold shadow-lg shadow-violet-500/30 hover:shadow-violet-500/50 hover:scale-105 transition-all duration-200'>
