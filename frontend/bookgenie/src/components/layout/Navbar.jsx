      ...
      <div className='flex items-center justify-between h-16'>
        ...
        <div className='hidden lg:flex items-center space-x-3'>
          {isAuthenticated ? (
            ...
            <>
              <a href='/login' className='px-4 py-2 text-sm font-medium text-gray-600 hover:text-gray-900 rounded-lg hover:bg-gray-50 transition-all duration-200'>Login</a>
              <a href='/signup' className='px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-violet-400 to-purple-500 rounded-lg hover:from-violet-700 hover:to-purple-700 shadow-lg shadow-violet-500/30 hover:shadow-violet-500/50 transition-all duration-200 hover:scale-105'>Get Started</a>
            </>
          )}
        </div>
