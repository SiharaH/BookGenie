            ...
            <div className='px-8 py-6'>
                <div className='flex flex-col md:flex-row md:items-center gap-4 md:gap-0 justify-between'>
                    <div>
                        ...
                        <p className='text-sm md:text-base text-gray-500 mt-1'>Editing {currentChapter.title || `Chapter ${selectedChapterIndex + 1}`}</p>
                    </div>
                    ...
                    <div className='flex items-center gap-3'>
                        ...
                        <div className="flex items-center border border-gray-200 rounded-lg overflow-hidden">
                            <button
                                ...
                                className={`px-3 py-2 text-sm font-medium transition-colors ${
                                    !isPreviewMode ? "bg-violet-50 text-violet-700 border-r border-violet-200" : "text-gray-600 hover:bg-gray-50"
                            }`}>
                                Edit
                            </button>
                            <button
                                ...
                                className={`px-3 py-2 text-sm font-medium transition-colors ${
                                    isPreviewMode ? "bg-violet-50 text-violet-700" : "text-gray-600 hover:bg-gray-50"
                                }`}>
                                Preview
                            </button>
                        </div>
                        ...
                        <button 
                            ...
                            className="p-2 hover:bg-gray-100 rounded-lg transition-colors text-gray-600" title='Toggle Fullscreen'>
                        ...
                        {isPreviewMode ? (
                            <div className='h-full border border-gray-200 rounded-lg overflow-y-auto'>
                                ...
                                <div className='p-8'>
                                    ...
                                    dangerouslySetInnerHTML={{__html: currentChapter.content ? formatMarkdown(currentChapter.content) : "<p class='text-gray-400 italic'>No content to preview</p>"}}
                                     />
                                    </div>
                                    </div>
                                    ) : (
